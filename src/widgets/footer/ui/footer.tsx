...
export const Footer = () => {
  return (
    <footer className={styles.footer}>
      <Flex gap='16px' padding={{ base: '40px 15px', md: '64px 15px', lg: '64px' }} margin='0 auto' maxWidth='1440px'>
        <Flex width={{ base: '100%', md: '50%' }} direction='column' justify='space-between' gap='32px'>
          <LogoLink/>
          <Box hideFrom='lg'>
            <FooterNavigation/>
          </Box>
