...
export const BookComments = () => {
  return (
    <Flex flexDir={'column'}>
      <Heading mb={'8px'} fontFamily={'Inter'} fontSize={'20px'} fontWeight={600} lineHeight={'150%'} color={'rgba(3, 7, 18, 1)'}>Відгуки (15)</Heading>
      <Separator mb={'16px'} />
      ...
      <Flex w={'100%'} justifyContent={'space-between'} alignItems={'center'}>
        <Button borderRadius={'8px'} bgColor={'kowo.solid'} color={'rgba(245, 245, 245, 1)'} p={'6px 12px'}>Залишити відгук</Button>
